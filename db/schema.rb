...
ActiveRecord::Schema.define(version: 2021_03_09_184519) do
  ...
  create_table "enologists_wines", id: false, force: :cascade do |t|
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["enologist_id"], name: "index_roles_on_enologist_id"
